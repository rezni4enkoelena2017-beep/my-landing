  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Цена зависит от задачи. Лендинг — от 45 000 ₽, AI-агент — от 70 000 ₽, веб-приложение — от 130 000 ₽. После первого созвона дам точную цифру — без скрытых доплат.",
      },
    },
    {
      "@type": "Question",
