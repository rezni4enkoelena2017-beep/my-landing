    ...
    >
      {tag && (
        <span
          ...
          text-[var(--color-accent)] border border-[var(--color-accent)]/30 rounded-full px-3 py-1 w-fit"
        >
      ...
      <h2
        className="text-[clamp(2rem,4vw,3.5rem)] font-bold leading-tight tracking-tight text-[var(--color-text)]"
      >
        {highlight ? (
          <>
            {title}{" "}
